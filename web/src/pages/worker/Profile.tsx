    ...
    <WorkerLayout>
      <div className="max-w-2xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-500 text-sm mt-1">Ces informations sont visibles par les clients</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <Card className="mb-4">
            ...
            <CardBody className="space-y-4">
              ...
              <Input label="Téléphone" type="tel" placeholder="+225 07 00 00 00 00" error={errors.phone?.message} {...register('phone')} />
              <Input label="Localisation" placeholder="Ex: Cocody, Abidjan" {...register('location')} />
          ...
          <Card className="mb-4">
            ...
            <CardBody className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <Input label="Tarif horaire (FCFA)" type="number" placeholder="5000" {...register('hourly_rate')} />
