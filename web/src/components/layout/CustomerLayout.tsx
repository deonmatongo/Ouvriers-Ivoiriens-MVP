...
const nav = [
  { to: '/dashboard/customer', icon: LayoutDashboard, label: 'Tableau de bord' },
  { to: '/dashboard/customer/jobs', icon: Briefcase, label: 'Mes demandes' },
  { to: '/post-job', icon: PlusCircle, label: 'Nouvelle demande' },
